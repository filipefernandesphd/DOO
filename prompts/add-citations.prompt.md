...
3. execute `npm ls slidev-addon-citations @citation-js/core @citation-js/plugin-bibtex @citation-js/plugin-csl @citation-js/plugin-doi --depth=2` e confirme as versões resolvidas;
