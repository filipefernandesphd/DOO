...
aspectRatio: 16/10
info: |
  Aula sobre objeto, estado, comportamento e abstração, com uma atividade
  prática de criação de classes e objetos em Java.
themeConfig:
  variant: minimal
  lang: pt-BR
mdc: true
...
<div class="image-only-frame">
  <img src="../../assets/object.png" alt="Representação visual de um objeto">
</div>
...
![Objetos do cotidiano para classificar](../../assets/objetos-para-classificar.png)
...
![Objetos do cotidiano para observar seus estados](../../assets/objetos-para-classificar.png)
...
![Objetos do cotidiano para reconhecer comportamentos](../../assets/objetos-para-classificar.png)
...
<div class="vscode-mark">
  <img src="../../assets/visual-studio-code.svg" alt="Logotipo do Visual Studio Code">
</div>
