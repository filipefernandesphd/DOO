public class Main {
    public static void main(String args[]) {
        ...
        Aluno<String> aluno1 = new Aluno<String>("alunoum@gmail.com");
        ...
        Professor<String> prof1 = new Professor<String>("professor1@gmail.com");
        System.out.println(prof1.getIdentificacao());

        Professor<Integer> prof2 = new Professor<Integer>(984868);
        ...
        q1.adicionarVideoExtra("Quem descobriu o Brasil?");
        q1.adicionarVideoExtra("https://x.com/govbr/status/988160591448739840");
